...
* [Collection](#Collection)
    ...
    * _instance_
        ...
        * [.find(selector, options)](#Collection+find) ⇒ <code>Observable.&lt;T&gt;</code>
...
### collection.find(selector, options) ⇒ <code>Observable.&lt;T&gt;</code>
Method has the same notation as Mongo.Collection.find, only returns Observable.

**Kind**: instance method of <code>[Collection](#Collection)</code>  
**Returns**: <code>Observable.&lt;T&gt;</code> - RxJS Observable wrapped with Meteor features.  
